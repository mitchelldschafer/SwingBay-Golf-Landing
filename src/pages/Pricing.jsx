  ...
  return (
    <div className="min-h-screen bg-[var(--background)] py-24 px-6 font-sans">
      ...
      <div className="max-w-[1000px] mx-auto space-y-12">
        ...
        {/* MEMBERSHIP BOX */}
        <div className="border-2 border-yellow-400/80 rounded-[24px] p-8 md:p-12 shadow-[0_0_25px_rgba(250,204,21,0.15)] bg-black/40 backdrop-blur-sm relative overflow-hidden">
        ...
        {/* OPEN PLAY BOX */}
        <div className="border-2 border-blue-400/80 rounded-[24px] p-8 md:p-12 shadow-[0_0_25px_rgba(96,165,250,0.15)] bg-black/40 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="border border-cyan-400/50 hover:border-cyan-400 transition-colors rounded-[24px] p-8 text-center shadow-[0_0_15px_rgba(34,211,238,0.1)] hover:shadow-[0_0_25px_rgba(34,211,238,0.2)] bg-black/30 backdrop-blur-sm flex flex-col items-center justify-center min-h-[220px]">
          ...
          <div className="border border-yellow-400/50 hover:border-yellow-400 transition-colors rounded-[24px] p-8 text-center shadow-[0_0_15px_rgba(250,204,21,0.1)] hover:shadow-[0_0_25px_rgba(250,204,21,0.2)] bg-black/30 backdrop-blur-sm flex flex-col items-center justify-center min-h-[220px]">
          ...
          <div className="border border-red-500/50 hover:border-red-500 transition-colors rounded-[24px] p-8 text-center shadow-[0_0_15px_rgba(239,68,68,0.1)] hover:shadow-[0_0_25px_rgba(239,68,68,0.2)] bg-black/30 backdrop-blur-sm flex flex-col items-center justify-center min-h-[220px]">
          ...
          <div className="border border-green-500/50 hover:border-green-500 transition-colors rounded-[24px] p-8 text-center shadow-[0_0_15px_rgba(34,197,94,0.1)] hover:shadow-[0_0_25px_rgba(34,197,94,0.2)] bg-black/30 backdrop-blur-sm flex flex-col items-center justify-center min-h-[220px]">
